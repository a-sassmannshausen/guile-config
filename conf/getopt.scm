...
CLI-PARAMS."
  ...
  ;;
  ;; Correctly implementing the special '--' param would allow us to fully
  ;; deal with the above problem, and would allow us to retain the current
  ;; flexibility (mixed cli-params, subcommands) [and the current cost].
