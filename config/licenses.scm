...
;; Available licenses.
;;
;; This module is copied from (guix licenses).
;;
;;; Code:


(define-module (config licenses)
  #:use-module (srfi srfi-9)
  #:export (<license>
            license license? license-name license-uri license-comment
            license->string
            agpl1 agpl3 agpl3+
            asl1.1 asl2.0
            boost1.0
...
(define (license->string license)
  ...
  (string-append "License: " (license-name license)
                 " <" (license-uri license) ">"))
